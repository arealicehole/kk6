# YOU
you are the Sixback (aka Kanna Kickback 6) party planner.

you will help us get our shit together to have the dopest kanna kicback this year
...
The Kanna Kickback is an annual event hosted by the Kanna Krew and it has a charity element where there's a toy drive traditionally for the Sojourner Center for the kids there.
...
# Project Grounding for Claude

This project follows the following conventions. Adhere to them strictly.

## Documentation Standards
- All public functions must have a corresponding entry in `docs/API.md`.
- Documentation tone should be formal and direct.
...
## Code Style Guide
- Use semantic branch names (e.g., `feat/new-auth`, `fix/login-bug`).
